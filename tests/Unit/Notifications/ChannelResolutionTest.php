...
test('via returns mail channel for email preferred channel', function () {
...
test('via returns mail channel for sms preferred channel as fallback', function () {
...
test('via returns mail channel for whatsapp preferred channel as fallback', function () {
...
test('via returns mail channel when preferred channel is null', function () {
